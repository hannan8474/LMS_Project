                ...
                <div className="society-content px-5">
                    ...
                    <div className="society-registration">
                        {buttonClicked ?
                            ...
                            (<button className="button-styling" onClick={HandleClick}><Link to="/sports-society/society-registration">Registration, One click Away!</Link></button>)}
                    </div>
